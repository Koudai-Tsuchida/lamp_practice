      ...
      <table class="table table-bordered text-center">
        ...
        <tbody>
          ...
          <tr class="<?php print htmlspecialchars(is_open($item) ? '' : 'close_item'); ?>">
            <td><img src="<?php print htmlspecialchars(IMAGE_PATH . $item['image']);?>" class="item_image"></td>
            <td><?php print htmlspecialchars($item['name']); ?></td>
            <td><?php print htmlspecialchars(number_format($item['price'])); ?>円</td>
            <td>
              <form method="post" action="admin_change_stock.php">
                <div class="form-group">
                  <!-- sqlインジェクション確認のためあえてtext -->
                  <input  type="text" name="stock" value="<?php print htmlspecialchars($item['stock']); ?>">
                  個
                </div>
